...
class PDFConverterApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PDF Converter - Versión 1")
        self.setGeometry(200, 200, 600, 400)

        layout = QVBoxLayout()

        title = QLabel("PDF Converter (Hybrid)")
        ...
        btn_input = QPushButton("Seleccionar PDFs")
        btn_input.clicked.connect(self.select_input)
        hbox1.addWidget(QLabel("Carpeta de PDFs:"))
        ...
        btn_output = QPushButton("Seleccionar salida")
        ...
        btn_convert.setStyleSheet("background-color: green; color: white; font-weight: bold;")
        btn_convert.clicked.connect(self.run_conversion)
    ...
    def select_input(self):
        folder = QFileDialog.getExistingDirectory(self, "Selecciona carpeta de PDFs")
        if folder:
    ...
    def run_conversion(self):
        ...
        QMessageBox.information(self, "Completado", f"Conversión terminada.\nArchivos guardados en:\n{output_folder}")

    def show_help(self):
        QMessageBox.information(self, "Ayuda",
            "Instrucciones de uso:\n\n"
            "1. Selecciona la carpeta donde están tus archivos PDF.\n"
            "2. Selecciona la carpeta de salida para guardar los Word.\n"
    ...
    def show_about(self):
        QMessageBox.information(self, "Acerca de",
            "PDF Converter - Versión 1\n\n"
            "Hecho por Daniel Donaldo Villanueva Canul\n"
            "Este programa convierte múltiples PDFs a Word editables."
        )
